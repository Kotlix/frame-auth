...
import ru.kotlix.frame.auth.server.service.exception.AuthenticationAlreadyExistsException
...
class AuthenticationServiceImpl(
    ...
    override fun basicRegister(
        ...
        MimeMessageHelper(mimeMessage, false).apply {
            ...
            setText(
                "Your verification token is: '$outToken'. Unless you verify your email in 15 minutes its bound account will be removed.",
            )
        }
    ...
    override fun verifyRegister(secret: String) {
        ...
        val confirmVerifyEntity =
            confirmVerifyRepository.findById(token.id)
    ...
    override fun serviceUserByToken(token: AccessToken): ServiceUser {
        ...
        val te =
            tokenRepository.findTokenByAuthId(tw.id)

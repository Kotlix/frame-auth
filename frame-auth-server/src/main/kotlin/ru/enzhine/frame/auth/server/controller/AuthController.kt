...
import ru.enzhine.frame.auth.api.AuthApi
...
class AuthController(
    ...
    @GetMapping("/login")
    override fun basicLogin(@RequestBody request: BasicLoginRequest): AccessToken {
    ...
    override fun basicRegister(@RequestBody request: BasicRegisterRequest) {
    ...
    override fun verifyRegister(@PathVariable("secret") secret: String) {
